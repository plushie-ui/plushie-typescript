...
export function onKeyPress(tag: string, opts?: { maxRate?: number }): Subscription {
  return sub("on_key_press", tag, opts);
}

/** Subscribe to key release events. */
export function onKeyRelease(tag: string, opts?: { maxRate?: number }): Subscription {
  return sub("on_key_release", tag, opts);
}

/** Subscribe to mouse move events. */
export function onMouseMove(tag: string, opts?: { maxRate?: number }): Subscription {
  return sub("on_mouse_move", tag, opts);
}

/** Subscribe to mouse button events. */
export function onMouseButton(tag: string, opts?: { maxRate?: number }): Subscription {
  return sub("on_mouse_button", tag, opts);
}

/** Subscribe to mouse scroll events. */
export function onMouseScroll(tag: string, opts?: { maxRate?: number }): Subscription {
...
export function onWindowResize(tag: string, opts?: { maxRate?: number }): Subscription {
...
export function onAnimationFrame(tag: string, opts?: { maxRate?: number }): Subscription {
...
export function onTouch(tag: string, opts?: { maxRate?: number }): Subscription {
  return sub("on_touch", tag, opts);
}

/** Subscribe to IME events. */
export function onIme(tag: string, opts?: { maxRate?: number }): Subscription {
...
export function onWindowEvent(tag: string, opts?: { maxRate?: number }): Subscription {
  return sub("on_window_event", tag, opts);
}

/** Subscribe to window open events. */
export function onWindowOpen(tag: string, opts?: { maxRate?: number }): Subscription {
  return sub("on_window_open", tag, opts);
}

/** Subscribe to window move events. */
export function onWindowMove(tag: string, opts?: { maxRate?: number }): Subscription {
  return sub("on_window_move", tag, opts);
}

/** Subscribe to keyboard modifier state changes (shift, ctrl, alt, etc.). */
export function onModifiersChanged(tag: string, opts?: { maxRate?: number }): Subscription {
  return sub("on_modifiers_changed", tag, opts);
}

/** Subscribe to any renderer event (catch-all). */
export function onEvent(tag: string, opts?: { maxRate?: number }): Subscription {
