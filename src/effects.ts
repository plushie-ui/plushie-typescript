...
function effectCmd(kind: string, opts: Record<string, unknown>, defaultTimeout: number): Command {
...
export function notification(title: string, body: string, opts: NotificationOptions = {}): Command {
