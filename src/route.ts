...
export function createRoute(path: string, params: Record<string, unknown> = {}): Route {
...
export function push(route: Route, path: string, params: Record<string, unknown> = {}): Route {
