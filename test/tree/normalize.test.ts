...
import { normalize, isAutoId } from "../../src/tree/normalize.js"
import type { UINode } from "../../src/types.js"

function node(id: string, type: string, props: Record<string, unknown> = {}, children: UINode[] = []): UINode {
  return Object.freeze({ id, type, props: Object.freeze(props), children: Object.freeze(children) })
}
