...
import { isClick, isToggle, isInput, target } from "../../src/index.js"
...
test("scoped_ids_match_local_id", () => {
  const event: WidgetEvent = {
    ...
    scope: ["form", "sidebar"], value: null, data: null,
  }
...
test("scoped_ids_dynamic_list_bind_parent", () => {
  const event: WidgetEvent = {
    kind: "widget", type: "toggle", id: "done",
    scope: ["item_42", "todoList"], value: true, data: null,
  }
...
test("scoped_ids_dynamic_list_delete", () => {
  const event: WidgetEvent = {
    kind: "widget", type: "click", id: "delete",
    scope: ["item_7", "todoList"], value: null, data: null,
  }
...
test("scoped_ids_depth_agnostic", () => {
  const event: WidgetEvent = {
    kind: "widget", type: "input", id: "query",
    scope: ["search", "sidebar", "root"], value: "hi", data: null,
  }
...
test("scoped_ids_exact_depth", () => {
  const event: WidgetEvent = {
    kind: "widget", type: "input", id: "query",
    scope: ["search"], value: "hi", data: null,
  }
...
test("scoped_ids_exact_depth_mismatch", () => {
  ...
  const event: WidgetEvent = {
    kind: "widget", type: "input", id: "query",
    scope: ["search", "panel"], value: "hi", data: null,
  }
...
test("scoped_ids_no_scope_mismatch", () => {
  ...
  const event: WidgetEvent = {
    kind: "widget", type: "click", id: "save",
    scope: ["form"], value: null, data: null,
  }
