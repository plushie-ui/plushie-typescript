...
import type {
  Event, WidgetEvent, KeyEvent, MouseEvent, TouchEvent,
  ImeEvent, WindowEvent, CanvasEvent, MouseAreaEvent,
  PaneEvent, SensorEvent, SystemEvent, TimerEvent,
  AsyncEvent, StreamEvent, EffectEvent, ModifiersEvent,
} from "../../src/types.js"
...
test("events_widget_input_guard", () => {
  const event: WidgetEvent = {
    kind: "widget", type: "input", id: "search", scope: [], value: "hello", data: null,
  }
...
test("events_widget_submit_guard", () => {
  const event: WidgetEvent = {
    kind: "widget", type: "submit", id: "search", scope: [], value: "query", data: null,
  }
...
test("events_widget_toggle_guard", () => {
  const event: WidgetEvent = {
    kind: "widget", type: "toggle", id: "darkMode", scope: [], value: true, data: null,
  }
...
test("events_widget_select_guard", () => {
  const event: WidgetEvent = {
    kind: "widget", type: "select", id: "themePicker", scope: [], value: "nord", data: null,
  }
...
test("events_widget_slide_guard", () => {
  const event: WidgetEvent = {
    kind: "widget", type: "slide", id: "volume", scope: [], value: 75, data: null,
  }
...
test("events_scope_sidebar_match", () => {
  const event: WidgetEvent = {
    kind: "widget", type: "click", id: "save", scope: ["sidebar"], value: null, data: null,
  }
  expect(isClick(event, "save")).toBe(true)
...
test("events_scope_main_match", () => {
  const event: WidgetEvent = {
    kind: "widget", type: "click", id: "save", scope: ["main"], value: null, data: null,
  }
  expect(isClick(event, "save")).toBe(true)
...
test("events_target_reconstruction", () => {
  const event: WidgetEvent = {
    kind: "widget", type: "click", id: "save",
    scope: ["form", "app"], value: null, data: null,
  }
...
test("events_key_press_cmd_s_guard", () => {
  const event: KeyEvent = {
    kind: "key", type: "press", key: "s",
    modifiedKey: "s", physicalKey: "KeyS",
    modifiers: { command: true, ctrl: false, shift: false, alt: false, logo: false },
    location: "standard", text: "s", repeat: false, tag: "keys", captured: false,
  }
...
test("events_key_press_escape_guard", () => {
  const event: KeyEvent = {
    kind: "key", type: "press", key: "Escape",
    modifiedKey: "Escape", physicalKey: "Escape",
    modifiers: { command: false, ctrl: false, shift: false, alt: false, logo: false },
    location: "standard", text: null, repeat: false, tag: "keys", captured: false,
  }
  expect(isKey(event, "press")).toBe(true)
...
test("events_mouse_moved_guard", () => {
  const event: MouseEvent = {
    kind: "mouse", type: "moved", x: 100, y: 200,
    button: null, deltaX: 0, deltaY: 0, tag: "mouse", captured: false,
  }
...
test("events_touch_pressed_guard", () => {
  const event: TouchEvent = {
    kind: "touch", type: "pressed", fingerId: 0, x: 50, y: 75, tag: "touch", captured: false,
  }
...
test("events_window_close_requested_guard", () => {
  const event: WindowEvent = {
    kind: "window", type: "close_requested", windowId: "main", tag: "", data: null,
  }
...
test("events_canvas_press_guard", () => {
  const event: CanvasEvent = {
    kind: "canvas", type: "press", id: "drawArea", scope: [],
    x: 42, y: 100, button: "left", data: null,
  }
...
test("events_sensor_resize_guard", () => {
  const event: SensorEvent = {
    kind: "sensor", type: "resize", id: "contentArea", scope: [],
...
test("events_async_result_ok_guard", () => {
  const event: AsyncEvent = {
    kind: "async", tag: "dataLoaded", result: { ok: true, value: "hello" },
  }
...
test("events_async_result_error_guard", () => {
  const event: AsyncEvent = {
    kind: "async", tag: "dataLoaded", result: { ok: false, error: "fail" },
  }
  expect(isAsync(event, "dataLoaded")).toBe(true)
...
test("events_effect_ok_guard", () => {
  const event: EffectEvent = {
    kind: "effect", requestId: "ef_1234", status: "ok",
...
test("events_effect_cancelled_guard", () => {
  const event: EffectEvent = {
    kind: "effect", requestId: "ef_1234", status: "cancelled",
...
test("events_pattern_prefix_match", () => {
  const event: WidgetEvent = {
    kind: "widget", type: "click", id: "nav:settings", scope: [], value: null, data: null,
  }
...
test("events_catch_all", () => {
  const event: WidgetEvent = {
    kind: "widget", type: "click", id: "unknown", scope: [], value: null, data: null,
  }
