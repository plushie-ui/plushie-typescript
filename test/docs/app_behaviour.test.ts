...
import { Command, Subscription } from "../../src/index.js";
import { normalize } from "../../src/tree/index.js";
import type { WindowEvent } from "../../src/types.js";
import { button, checkbox, column, row, text, textInput, window } from "../../src/ui/index.js";
    ...
    window("main", { title: "Todos" }, [
      column({ padding: 16, spacing: 8 }, [
        ...
        ...model.todos.map((todo) =>
          row({ id: todo.id, spacing: 8 }, [checkbox("toggle", todo.done), text(todo.text)]),
        ),
      ]),
    ]),
  );
