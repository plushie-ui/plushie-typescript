...
import {
  window, column, row, text, button, textInput, container, checkbox,
...
test("tutorial_step2_input_updates_model", () => {
  ...
  const event: WidgetEvent = {
    kind: "widget", type: "input", id: "newTodo",
    scope: [], value: "Buy milk", data: null,
  }
  ...
  const tree = normalize(
    window("main", { title: "Todos" }, [
      column({ id: "app", padding: 20, spacing: 12, width: "fill" }, [
        ...
        column({ id: "list", spacing: 4 }, model.todos.map(todo =>
          container(todo.id, {}, [
            row({ spacing: 8 }, [
...
test("tutorial_step4_toggle", () => {
  ...
  const event: WidgetEvent = {
    kind: "widget", type: "toggle", id: "toggle",
    scope: ["todo_1", "list", "app"], value: true, data: null,
  }
...
test("tutorial_step4_delete", () => {
  ...
  const event: WidgetEvent = {
    ...
    scope: ["todo_1", "list", "app"], value: null, data: null,
  }
